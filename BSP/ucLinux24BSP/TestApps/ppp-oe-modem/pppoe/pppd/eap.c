...
#define RCSID	"$Id: eap.c,v 1.1.1.1 2006-08-14 02:32:37 andy Exp $"
...
int len;
{
	...
	case EAPT_NAK:
		...
		printf("EAP: unexpected Nak in Request; ignored");
...
int len;
{
	...
	case EAPT_NAK:
		if (len < 1) {
			...
			printf("EAP: Nak Response with no suggested protocol");
			eap_figure_next_state(esp, 1);
			break;
		}
