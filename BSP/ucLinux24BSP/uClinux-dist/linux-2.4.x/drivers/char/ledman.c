...
static ledmap_t	nettel_old = {
	...
	0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x100, 0x200
};
...
static ledmap_t nettel_new = {
	...
	0x000, 0x000, 0x080, 0x004, 0x010, 0x000, 0x000, 0x100, 0x200
};
...
static ledmap_t nettel_new = {
	...
	0x000, 0x000, 0x080, 0x000, 0x000, 0x000, 0x000, 0x100, 0x200
};
...
static ledmap_t nt5272_std = {
	...
	0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x000, 0x001, 0x002
};
...
static ledmap_t se5410_std = {
	0x07f, 0x001, 0x002, 0x010, 0x010, 0x010, 0x010, 0x004, 0x004, 0x008,
	0x008, 0x000, 0x000, 0x000, 0x000, 0x054, 0x028, 0x040, 0x07c, 0x000,
	0x000, 0x000, 0x020, 0x000, 0x000, 0x000, 0x000, 0x001, 0x002
};
...
static void se5410_set(unsigned long bits)
{
	...
	save_and_cli(flags);
	SECUREEDGE_WRITE_IOPORT(~bits, 0x007f);
	restore_flags(flags);
}
...
static ledmap_t nt1500_std = {
	...
	0x002, 0x002, 0x000, 0x000, 0x000, 0x000, 0x000, 0x001, 0x002
};
...
static ledmap_t	nettel_std = {
	...
	0x000, 0x000, 0x100, 0x008, 0x004, 0x000, 0x000, 0x001, 0x002
};
...
static ledmap_t	nettel_std = {
	...
	0x00000080, 0x00000040, 0x00000001, 0x00000002
};
...
static ledmap_t	nettel_std = {
	...
	0x020, 0x000, 0x000, 0x000, 0x000, 0x048, 0x030, 0x200, 0x3fc, 0x004,
	0x000, 0x000, 0x004, 0x000, 0x000, 0x000, 0x000, 0x001, 0x002
};
