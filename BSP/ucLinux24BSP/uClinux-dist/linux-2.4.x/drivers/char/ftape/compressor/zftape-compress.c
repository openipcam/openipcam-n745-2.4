 ...
 */
 ...
 char zftc_src[] ="$Source: /usr/local/cvsroot/W90N745/uClinux-dist/linux-2.4.x/drivers/char/ftape/compressor/zftape-compress.c,v $";
 char zftc_rev[] = "$Revision: 1.1.1.1 $";
 char zftc_dat[] = "$Date: 2006-07-11 09:28:52 $";
