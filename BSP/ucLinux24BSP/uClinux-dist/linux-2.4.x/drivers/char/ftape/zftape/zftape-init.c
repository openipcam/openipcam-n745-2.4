...
char zft_src[] __initdata = "$Source: /usr/local/cvsroot/W90N745/uClinux-dist/linux-2.4.x/drivers/char/ftape/zftape/zftape-init.c,v $";
char zft_rev[] __initdata = "$Revision: 1.1.1.1 $";
char zft_dat[] __initdata = "$Date: 2006-07-11 09:28:52 $";
