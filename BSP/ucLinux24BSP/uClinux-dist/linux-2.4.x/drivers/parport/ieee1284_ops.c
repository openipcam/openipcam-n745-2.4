 ...
 *
 * HISTORY
 *     2004-2-16  Ver 1.0 Modified by PC34 SChen <schen@winbond.com.tw>
 *
 * REMARK
 *     None
 **************************************************************************/
				      ...
				      int flags)
{
	...
	PARPORT_DEBUG_INFO		//schen add 2004-1-19 13:34
	if (port->irq != PARPORT_IRQ_NONE) {
		//PARPORT_DEBUG_INFO		//schen add 2004-2-16 14:09
#ifndef WINBOND_83977		//schen add 2004-2-17 09:49
		parport_enable_irq (port);
#endif		//schen add 2004-2-17 09:49
		//PARPORT_DEBUG_INFO		//schen add 2004-2-16 14:10
		no_irq = 0;
	}
	...
	//PARPORT_DEBUG_INFO		//schen add 2004-2-16 14:00
	while (count < len) {
	...
	ready:
		//PARPORT_DEBUG_INFO		//schen add 2004-2-16 14:04
...
int ecp_forward_to_reverse (struct parport *port)
{
	...
	PARPORT_DEBUG_INFO		//schen add 2004-1-19 13:33
