 ...
 *
 * DESCRIPTION
 *     Parport driver of PC style For Linux
 *
 * DATA STRUCTURES
 *     None
 *
 ...
 *
 * HISTORY
 *     2004-2-12  Ver 1.0 Modified by PC34 SChen <schen@winbond.com.tw>
 *
 * REMARK
 *     None
 **************************************************************************/
...
#include <asm/hardware.h>		//schen add 2004-2-6 13:50
#include <gpio/gpio_interface.h>	//schen add 2004-2-6 13:50
#include <linux/w83977.h>		//schen add 2004-2-12 17:58
...
#define EFIR_REG	(W83977AF_BASE + 0x3F0)	//W83977AF EFIR Register address, schen add 2004-2-9 10:32
			   ...
			   unsigned char v)
{
	...
	PARPORT_DEBUG_INFO		//schen add 2004-1-19 11:28
	if (m != 0xff)
...
static int change_mode(struct parport *p, int m)
{
	...
	PARPORT_DEBUG_INFO		//schen add 2004-1-19 11:23
...
static int get_fifo_residue (struct parport *p)
{
	...
	PARPORT_DEBUG_INFO		//schen add 2004-1-19 13:23
...
{
	PARPORT_DEBUG_INFO		//schen add 2004-1-19 13:29
...
{
	PARPORT_DEBUG_INFO		//schen add 2004-1-19 13:30
	outb (d, DATA (p));
}
...
{
	PARPORT_DEBUG_INFO		//schen add 2004-1-19 13:27
	__parport_pc_frob_control (p, 0x10, 0);
}

void parport_pc_enable_irq(struct parport *p)
{
	PARPORT_DEBUG_INFO		//schen add 2004-1-19 13:28
...
#ifndef WINBOND_83977		//schen add 2004-2-6 15:18
...
static void __devinit show_parconfig_smsc37c669(int io, int key)
{
	...
	PARPORT_DEBUG_INFO		//schen add 2004-1-19 13:31
	outb(key,io);
	outb(key,io);
	outb(1,io);
	cr1=inb(io+1);
...
#endif /*WINBOND_83977*/		//schen add 2004-2-6 15:18
...
static void __devinit show_parconfig_winbond(int io, int key)
{
	...
	//printk("CR60 = %d, CR61 = %d\n", cr60, cr61);	//schen add 2004-2-12 17:42
	...
	if(cr30 & 0x01) { /* the settings can be interrogated later ... */
		...
		if(i==NR_SUPERIOS) 
			...
			printk("superios[i], i = %d\n", i);		//schen add 2004-2-12 17:37
			superios[i].io = W83977AF_BASE + ((cr60<<8)|cr61);
			printk("superios[i].io = 0x%x\n", superios[i].io);	//schen add 2004-2-12 17:37
			//superios[i].irq = cr70&0x0f;		//schen del 2004-2-9 15:28
			superios[i].irq = 0x04;		//schen add 2004-2-9 15:28
...
#ifndef WINBOND_83977		//schen add 2004-2-6 15:17
static void __devinit decode_smsc(int efer, int key, int devid, int devrev)
{
    const char *type = "unknown";
	
	PARPORT_DEBUG_INFO		//schen add 2004-1-19 11:24
...
#endif /*WINBOND_83977*/		//schen add 2004-2-6 15:17


static void __devinit detect_and_report_winbond (void)
{ 
	PARPORT_DEBUG_INFO		//schen add 2004-1-18 15:45
...
#ifndef WINBOND_83977		//schen add 2004-2-6 15:19
...
#endif /*WINBOND_83977*/		//schen add 2004-2-6 15:20
...
static int __devinit parport_ECR_present(struct parport *pb)
{
	...
	PARPORT_DEBUG_INFO		//schen add 2004-1-19 13:26
	outb (r, CONTROL (pb));
...
static int __devinit parport_PS2_supported(struct parport *pb) 
{ 
	PARPORT_DEBUG_INFO		//schen add 2004-1-19 13:24
	return 0; 
}
#ifdef CONFIG_PARPORT_PC_FIFO
static int __devinit parport_ECP_supported(struct parport *pb) 
...
static int __devinit parport_EPP_supported(struct parport *pb) 
{ 
	PARPORT_DEBUG_INFO		//schen add 2004-1-19 13:25
	return 0; 
}
static int __devinit parport_ECPEPP_supported(struct parport *pb)
{
...
static int __devinit parport_irq_probe(struct parport *pb)
{
	...
	PARPORT_DEBUG_INFO		//schen add 2004-1-18 15:44
	if (priv->ecr) {
	...
	printk(KERN_INFO "Parport irq number: %d\n", pb->irq);	//schen add 2004-2-12 15:47
				       ...
				       struct pci_dev *dev)
{
	...
	PARPORT_DEBUG_INFO		//schen add 2004-1-18 15:43
	...
	p->private_data = priv;
	printk(KERN_INFO "Parport io address: 0x%x, 0x%x\n", p->base, p->base_hi);	//schen add 2004-2-16 10:00
...
#undef printmode
	...
	if (p->irq != PARPORT_IRQ_NONE) {
		printk(KERN_INFO "Before request_irq, parport irq number: %d\n", p->irq);	//schen add 2004-2-16 10:00
		// *((volatile unsigned int *) 0xFFF82010) = 0x07; //SCR: low level active ! schen add 2004-2-16 14:37
		
		if (request_irq (p->irq, parport_pc_interrupt,
				 SA_SHIRQ, p->name, p)) {	//schen modify 0 to SA_SHIRQ 2004-2-12 15:11
...
#ifdef CONFIG_PARPORT_PC_FIFO
		if (p->dma != PARPORT_DMA_NONE) {
			printk(KERN_INFO "Before request_dma, parport dma number: %d\n", p->dma);	//schen add 2004-2-16 10:00
...
static int __init parport_pc_init_superio (int autoirq, int autodma)
{
	...
	PARPORT_DEBUG_INFO		//schen add 2004-1-18 15:40
...
static int __init parport_pc_init_superio(int autoirq, int autodma) 
{
	PARPORT_DEBUG_INFO		//schen add 2004-1-19 11:12
	return 0;
}
#endif /* CONFIG_PCI */
...
parport_pc_find_isa_ports (int autoirq, int autodma)
{
...
#ifndef WINBOND_83977		//schen add 2004-2-17 13:51
	...
	if (parport_pc_probe_port(0x278, 0x678, autoirq, autodma, NULL))
		count++;
#else	//schen add 2004-2-17 13:51
	/*--- schen add 2004-2-17 13:51 ---*/
	printk(KERN_INFO "Parport parameter: io = 0x%x, irq = 0x%x, dma = 0x%x\n", superios[0].io, superios[0].irq, superios[0].dma);	//schen add 2004-2-13 15:50
	if (parport_pc_probe_port(superios[0].io, superios[0].io + 0x400, superios[0].irq, superios[0].dma, NULL))
		count++;
	/*---------------------------------*/
#endif	//schen add 2004-2-17 13:51
...
static int __init parport_pc_find_ports (int autoirq, int autodma)
{
	...
	PARPORT_DEBUG_INFO		//schen add 2004-1-18 15:39
#ifdef CONFIG_PARPORT_PC_SUPERIO
	PARPORT_DEBUG_INFO		//schen add 2004-1-18 15:39
	detect_and_report_winbond ();
#ifndef WINBOND_83977		//schen add 2004-2-6 15:25
	PARPORT_DEBUG_INFO		//schen add 2004-1-19 11:16
	detect_and_report_smsc ();
#endif /*WINBOND_83977*/	//schen add 2004-2-6 15:25
#endif

	PARPORT_DEBUG_INFO		//schen add 2004-1-19 11:14
	/* Onboard SuperIO chipsets that show themselves on the PCI bus. */
	count += parport_pc_init_superio (autoirq, autodma);

	PARPORT_DEBUG_INFO		//schen add 2004-1-18 17:03
...
int __init parport_pc_init (int *io, int *io_hi, int *irq, int *dma)
{
	...
	PARPORT_DEBUG_INFO		//schen add 2004-1-18 15:38
	if (io && *io) {
		PARPORT_DEBUG_INFO	//schen add 2004-1-18 15:38
