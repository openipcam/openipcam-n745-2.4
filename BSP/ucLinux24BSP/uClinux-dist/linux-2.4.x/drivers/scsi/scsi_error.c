...
static const char RCSid[] = "$Header: /usr/local/cvsroot/W90N745/uClinux-dist/linux-2.4.x/drivers/scsi/scsi_error.c,v 1.1.1.1 2006-07-11 09:29:30 andy Exp $";
...
STATIC int scsi_request_sense(Scsi_Cmnd * SCpnt)
{
	...
	memcpy((void *) SCpnt->cmnd, (void *) generic_sense,
	       sizeof(generic_sense));
	memcpy((void *)((unsigned char *)((unsigned long)SCpnt->cmnd|0x80000000)), (void *) generic_sense,
	       sizeof(generic_sense));
#endif
...
STATIC int scsi_test_unit_ready(Scsi_Cmnd * SCpnt)
{
	...
	memcpy((void *) SCpnt->cmnd, (void *) tur_command,
	       sizeof(tur_command));
	memcpy((void *)((unsigned char *)((unsigned long)SCpnt->cmnd|0x80000000)), (void *) tur_command,
	       sizeof(tur_command));
#endif
