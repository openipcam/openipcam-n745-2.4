...
/*
   static const char RCSid[] = "$Header: /usr/local/cvsroot/W90N745/uClinux-dist/linux-2.4.x/drivers/scsi/scsi.c,v 1.1.1.1 2006-07-11 09:29:29 andy Exp $";
 */
...
void scsi_init_cmd_from_req(Scsi_Cmnd * SCpnt, Scsi_Request * SRpnt)
{
	...
	memcpy((void *) SCpnt->cmnd, (const void *) SRpnt->sr_cmnd, 
	       sizeof(SCpnt->cmnd));
	memcpy((void *)((unsigned char *)((unsigned long)SCpnt->cmnd|0x80000000)),(const void *) SRpnt->sr_cmnd, 
		 ...
		 int timeout, int retries)
{
	...
	memcpy((void *) SCpnt->cmnd, (const void *) cmnd, 
               sizeof(SCpnt->cmnd));
	memcpy((void *)((unsigned char *)((unsigned long)SCpnt->cmnd|0x80000000)), (const void *) cmnd, 
               sizeof(unsigned char)*MAX_COMMAND_SIZE);              
#endif               
	/* Zero the sense buffer.  Some host adapters automatically request
	 * sense on error.  0 is not a valid sense code.
...
int scsi_retry_command(Scsi_Cmnd * SCpnt)
{
	...
	memcpy((void *) SCpnt->cmnd, (void *) SCpnt->data_cmnd,
	       sizeof(SCpnt->data_cmnd));
	memcpy((void *)((unsigned char *)((unsigned long)SCpnt->cmnd|0x80000000)), (void *) SCpnt->data_cmnd,
	       sizeof(SCpnt->data_cmnd));
#endif	       
...
#else
	memset(&SCpnt->cmnd, '\0', sizeof(SCpnt->cmnd));
	memset(((unsigned char *)((unsigned long)SCpnt->cmnd|0x80000000)), '\0', sizeof(unsigned char)*MAX_COMMAND_SIZE);
#endif    
