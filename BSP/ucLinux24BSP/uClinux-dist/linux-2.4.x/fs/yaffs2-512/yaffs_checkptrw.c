...
const char *yaffs_checkptrw_c_version =
    "$Id: yaffs_checkptrw.c,v 1.1.1.1 2007-07-31 05:18:10 andy Exp $";
...
{
#ifdef DEBUG_YAFFS2
printk("yaffs_CheckpointSpaceOk\n");
#endif
...
{
#ifdef DEBUG_YAFFS2
printk("yaffs_CheckpointFindNextErasedBlock\n");
#endif
	int  i;
	int blocksAvailable = dev->nErasedBlocks - dev->nReservedBlocks;
...
{
#ifdef DEBUG_YAFFS2
printk("yaffs_CheckpointFindNextCheckpointBlock\n");
#endif
...
{
#ifdef DEBUG_YAFFS2
printk("yaffs_CheckpointFlushBuffer\n");
#endif
	int chunk;
...
#ifdef DEBUG_YAFFS2
printk("yaffs_CheckpointInvalidateStream\n");
#endif
