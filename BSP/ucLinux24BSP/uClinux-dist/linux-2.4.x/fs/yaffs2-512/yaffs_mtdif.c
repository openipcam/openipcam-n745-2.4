...
const char *yaffs_mtdif_c_version =
    "$Id: yaffs_mtdif.c,v 1.1.1.1 2007-07-31 05:18:10 andy Exp $";
...
{
#ifdef DEBUG_YAFFS2
printk("nandmtd_WriteChunkToNAND\n");
#endif
...
{
#ifdef DEBUG_YAFFS2
printk("nandmtd_ReadChunkFromNAND\n");
#endif
	struct mtd_info *mtd = (struct mtd_info *)(dev->genericDevice);
	size_t dummy;
	int retval = 0;
...
#ifdef DEBUG_YAFFS2
printk("nandmtd_EraseBlockInNAND\n");
#endif
	struct mtd_info *mtd = (struct mtd_info *)(dev->genericDevice);
	__u32 addr =
