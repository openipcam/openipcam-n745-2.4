/* $Header: /usr/local/cvsroot/W90N745/uClinux-dist/user/tcsh/mi.termios.c,v 1.1.1.1 2006-07-11 09:33:24 andy Exp $ */
/* termios.c - fake termios interface using sgtty interface 
 * 	       by Magnus Doell and Bruce Evans.
 *
 */
#include "sh.h"
RCSID("$Id: mi.termios.c,v 1.1.1.1 2006-07-11 09:33:24 andy Exp $")
