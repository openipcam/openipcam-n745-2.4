 ...
 *------------------------------------------------------------------
 *
 * $Source: /usr/local/cvsroot/W90N745/uClinux-dist/user/e2fsprogs/lib/ss/test_ss.c,v $
 * $Revision: 1.1.1.1 $
 * $Date: 2006-07-11 09:30:55 $
 * $State: Exp $
 * $Author: andy $
 * $Locker:  $
 *
 * $Log: test_ss.c,v $
 * Revision 1.1.1.1  2006-07-11 09:30:55  andy
 * W90N745 BSP
 *
 * Revision 1.1.1.1  2006/04/26 02:33:03  andy
...
static char const rcsid_test_c[] =
    "$Header: /usr/local/cvsroot/W90N745/uClinux-dist/user/e2fsprogs/lib/ss/test_ss.c,v 1.1.1.1 2006-07-11 09:30:55 andy Exp $";
#endif /* lint */
