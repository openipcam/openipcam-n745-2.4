...
#define DEFAULT_MIBDIRS "/lib/snmp/mibs"
...
#define PERSISTENT_DIRECTORY "/var/log"
...
#ifdef EMBED
#define EMBEDDED_CONFIG_PATH "/etc/config"
// #define EMBEDDED_CONFIG_PATH "/etc/config" ENV_SEPARATOR "/etc/default"
#else
...
#define CACHEFILE "/var/tmp/.snmp-exec-cache" /*MORE*/
...
#define CONFIGURE_OPTIONS " --target=m68k-gnu-linux"
