...
#-------------------------------------------------------------------------------
#                                                                                                                         
# $Id: netstat-nat.c,v 1.1.1.1 2006-07-11 09:31:32 andy Exp $     
#       
# $Log: netstat-nat.c,v $
# Revision 1.1.1.1  2006-07-11 09:31:32  andy
# W90N745 BSP
#
# Revision 1.1.1.1  2006/04/26 02:34:20  andy
...
static char const rcsid[] = "$Id: netstat-nat.c,v 1.1.1.1 2006-07-11 09:31:32 andy Exp $";
char SRC_IP[35];
char DST_IP[35];
int SNAT = 1;
int DNAT = 1;
