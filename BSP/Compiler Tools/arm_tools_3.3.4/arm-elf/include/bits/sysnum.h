...
#undef __NR_FindImage
#define __NR_FindImage (0x900000 +222)
#define SYS_FindImage __NR_FindImage
#undef __NR_DelImage
#define __NR_DelImage (0x900000 +223)
#define SYS_DelImage __NR_DelImage
#undef __NR_CorruptCheck
#define __NR_CorruptCheck (0x900000 +224)
#define SYS_CorruptCheck __NR_CorruptCheck
#undef __NR_ReadWinbondFlash
#define __NR_ReadWinbondFlash (0x900000 +225)
#define SYS_ReadWinbondFlash __NR_ReadWinbondFlash
#undef __NR_WriteWinbondFlash
#define __NR_WriteWinbondFlash (0x900000 +226)
#define SYS_WriteWinbondFlash __NR_WriteWinbondFlash
#undef __NR_GPIO_I2C_Byte_Xfer
#define __NR_GPIO_I2C_Byte_Xfer (0x900000 +231)
#define SYS_GPIO_I2C_Byte_Xfer __NR_GPIO_I2C_Byte_Xfer
#undef __NR_GPIO_SPI_Send_Byte
#define __NR_GPIO_SPI_Send_Byte (0x900000 +232)
#define SYS_GPIO_SPI_Send_Byte __NR_GPIO_SPI_Send_Byte
